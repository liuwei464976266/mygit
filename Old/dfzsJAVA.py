...
SCATTER = '12'
BASEBET = 25
INITURL = "http://192.168.10.212:8001/callInitialize"
GETSLOTURL = "http://192.168.10.212:8001/getSlotData"
REGISTER = "http://192.168.10.212:8001/registerUser"
...
def checkLotteryInitialize(tk,gametype,lastresponse):#核对断线重连初始化
    ...
    if response['et']['data']['lastData'] != lastresponse['et']['data']:
        print('断线重连有误',"response['et']['data']['lastData']___", response['et']['data']['lastData'], "---lastresponse['et']['data']___", lastresponse['et']['data'])
        return False
    return True
